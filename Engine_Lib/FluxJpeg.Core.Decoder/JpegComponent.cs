...
namespace FluxJpeg.Core.Decoder
{
	...
	{
		public delegate void DecodeFunction(JPEGBinaryReader jpegReader, float[] zigzagMCU);
		...
		private int factorUpV => parent.MaxV / (int)factorV;

		private int factorUpH => parent.MaxH / (int)factorH;
