...
namespace NVorbis
{
	public abstract class VorbisResidue
	{
		private class Residue0 : VorbisResidue
		{
			...
			public override float[][] Decode(DataPacket packet, bool[] doNotDecode, int channels, int blockSize)
			{
		...
		public abstract float[][] Decode(DataPacket packet, bool[] doNotDecode, int channels, int blockSize);
