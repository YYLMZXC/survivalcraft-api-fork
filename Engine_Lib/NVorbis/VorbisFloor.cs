...
namespace NVorbis
{
	public abstract class VorbisFloor
	{
		public abstract class PacketData
		{
			internal int BlockSize;

			protected abstract bool HasEnergy
			{
				get;
			}
		...
		private class Floor0 : VorbisFloor
		{
			...
			public override PacketData UnpackPacket(DataPacket packet, int blockSize, int channel)
			{
			...
			public override void Apply(PacketData packetData, float[] residue)
			{
		...
		public abstract PacketData UnpackPacket(DataPacket packet, int blockSize, int channel);

		public abstract void Apply(PacketData packetData, float[] residue);
	}
}
