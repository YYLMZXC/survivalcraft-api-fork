...
namespace SimpleJson.Reflection
{
	...
	internal class ReflectionUtils
	{
		...
		{
			if ((object)info == null || (object)type == null || !info.IsDefined(type))
			{
				return null;
			}
		...
		public static Type GetGenericListElementType(Type type)
		{
			...
			{
				if (IsTypeGeneric(implementedInterface) && (object)implementedInterface.GetGenericTypeDefinition() == typeof(IList<>))
				{
		...
		{
			if ((object)objectType == null || (object)attributeType == null || !objectType.GetTypeInfo().IsDefined(attributeType))
			{
				return null;
			}
		...
		public static bool IsTypeDictionary(Type type)
		{
			...
			return (object)type.GetGenericTypeDefinition() == typeof(IDictionary<, >);
		}
		...
		public static ConstructorInfo GetConstructorInfo(Type type, params Type[] argsType)
		{
			foreach (ConstructorInfo constructor in GetConstructors(type))
			{
				...
				{
					if ((object)parameters2[i].ParameterType != argsType[num])
					{
						flag = false;
						break;
					}
