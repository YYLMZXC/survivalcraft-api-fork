	...
	internal class PocoJsonSerializerStrategy : IJsonSerializerStrategy
	{
		...
		public virtual object DeserializeObject(object value, Type type)
		{
			...
			if (text != null)
			{
				...
				result = (((object)type == typeof(Guid)) ? ((object)default(Guid)) : ((!ReflectionUtils.IsNullableType(type) || (object)Nullable.GetUnderlyingType(type) != typeof(Guid)) ? text : null));
			...
			{
				result = (((object)type == typeof(int) || (object)type == typeof(long) || (object)type == typeof(double) || (object)type == typeof(float) || (object)type == typeof(bool) || (object)type == typeof(decimal) || (object)type == typeof(byte) || (object)type == typeof(short)) ? Convert.ChangeType(value, type, CultureInfo.InvariantCulture) : value);
