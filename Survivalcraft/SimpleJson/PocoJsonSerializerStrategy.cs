...
namespace SimpleJson
{
	...
	internal class PocoJsonSerializerStrategy : IJsonSerializerStrategy
	{
		...
		public static readonly string[] Iso8601Format = new string[3]
		{
		...
		public virtual object DeserializeObject(object value, Type type)
		{
			...
			{
				result = ((type == typeof(int) || type == typeof(long) || type == typeof(double) || type == typeof(float) || type == typeof(bool) || type == typeof(decimal) || type == typeof(byte) || type == typeof(short)) ? Convert.ChangeType(value, type, CultureInfo.InvariantCulture) : value);
