...
namespace Game
{
	public class BulletinDialog : Dialog
	{
		...
		public BulletinDialog(string title, string content, string time, Action action, Action<LabelWidget, LabelWidget> action2, Action<LabelWidget, LabelWidget> action3)
		{
