...
namespace Game
{
    public class SubsystemModelsRenderer : Subsystem, IDrawable
    {
        ...
        public override void Load(ValuesDictionary valuesDictionary)
        {
            ...
            m_shaderOpaque =  new ModelShader(ShaderCode.Get("Shaders/Model.vsh"), ShaderCode.Get("Shaders/Model.psh"), useAlphaThreshold: false, MaxInstancesCount);
            m_shaderAlphaTested =  new ModelShader(ShaderCode.Get("Shaders/Model.vsh"), ShaderCode.Get("Shaders/Model.psh"), useAlphaThreshold: true, MaxInstancesCount);
