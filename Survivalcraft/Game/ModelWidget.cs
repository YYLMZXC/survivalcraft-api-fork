...
namespace Game
{
	public class ModelWidget : Widget
	{
		...
		public override void Draw(DrawContext dc)
		{
			...
			Matrix matrix = ((AutoRotationVector.LengthSquared() > 0f) ? Matrix.CreateFromAxisAngle(Vector3.Normalize(AutoRotationVector), AutoRotationVector.Length() * num2) : Matrix.Identity);
			foreach (ModelMesh mesh in Model.Meshes)
			{
				litShader.Transforms.World[0] = m_absoluteBoneTransforms[mesh.ParentBone.Index] * ModelMatrix * matrix;
