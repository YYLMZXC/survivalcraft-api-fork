	...
	public class WaterSplashParticleSystem : ParticleSystem<WaterSplashParticleSystem.Particle>
	{
			...
			: base(60)
		{
			...
			for (int i = 0; i < base.Particles.Length; i++)
			{
				...
				Vector3 vector = 1.5f * m_random.Float(0f, 1f) * Vector3.Normalize(new Vector3(m_random.Float(-1f, 1f), 0f, m_random.Float(-1f, 1f)));
				obj.Velocity = num5 * (vector + new Vector3(0f, m_random.Float(0f, 5f), 0f));
			}
		}
