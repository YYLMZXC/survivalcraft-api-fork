			...
			: base(300)
		{
			...
			case FireworksBlock.Shape.Circle:
			{
				...
				for (int j = 0; j < num5; j++)
				{
					...
					Vector3 vector2 = new Vector3(MathUtils.Sin(x2) + 0.1f * m_random.Float(-1f, 1f), 0f, MathUtils.Cos(x2) + 0.1f * m_random.Float(-1f, 1f));
			...
			case FireworksBlock.Shape.Disc:
			{
				...
				for (int m = 0; m <= num11; m++)
				{
					...
					for (int n = 0; n < num13; n++)
					{
						...
						Vector3 vector4 = new Vector3(num12 * MathUtils.Sin(x5) + 0.1f * m_random.Float(-1f, 1f), 0f, num12 * MathUtils.Cos(x5) + 0.1f * m_random.Float(-1f, 1f));
			...
			case FireworksBlock.Shape.Ball:
			{
				...
				for (int num16 = 0; num16 <= num15; num16++)
				{
					...
					for (int num19 = 0; num19 < num18; num19++)
					{
						...
						vector5.X = num17 * MathUtils.Sin(x7);
						vector5.Z = num17 * MathUtils.Cos(x7);
			...
			case FireworksBlock.Shape.LongTrails:
			{
				...
				for (int k = 0; k <= num7; k++)
				{
					...
					for (int l = 0; l < num9; l++)
					{
						...
						vector3.X = num8 * MathUtils.Sin(x4) + 0.3f * m_random.Float(-1f, 1f);
						vector3.Y = MathUtils.Cos(x3) + 0.3f * m_random.Float(-1f, 1f);
						vector3.Z = num8 * MathUtils.Cos(x4) + 0.3f * m_random.Float(-1f, 1f);
						...
						obj3.Velocity = ((shape == FireworksBlock.Shape.ShortTrails) ? (25f * vector3) : (35f * vector3));
			...
			case FireworksBlock.Shape.FlatTrails:
			{
				...
				for (int i = 0; i < num3; i++)
				{
					...
					Vector3 vector = new Vector3(MathUtils.Sin(x) + 0.1f * m_random.Float(-1f, 1f), 0f, MathUtils.Cos(x) + 0.1f * m_random.Float(-1f, 1f));
					Particle obj = base.Particles[m_nextParticle++];
					obj.IsActive = true;
					obj.Position = position;
					obj.Size = new Vector2(0.25f);
					obj.TimeToLive = m_random.Float(0.5f, 2.5f);
					obj.Velocity = 25f * vector;
