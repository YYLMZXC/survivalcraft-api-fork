				...
				case FireworksBlock.Shape.Disc:
					{
						...
						for (int m = 0; m <= num11; m++)
						{
							...
							int num13 = (int)Math.Round(num12 * 2f * num11);
				...
				case FireworksBlock.Shape.Ball:
					{
						...
						for (int num16 = 0; num16 <= num15; num16++)
						{
							...
							int num18 = (int)Math.Round(num17 * 2f * num15);
		...
		public override bool Simulate(float dt)
		{
			...
			for (int i = 0; i < Particles.Length; i++)
			{
				...
				if (particle.TimeToLive > 0f)
				{
					...
					particle.Color = particle.BaseColor * MathF.Min(particle.FadeRate * particle.TimeToLive, 1f);
