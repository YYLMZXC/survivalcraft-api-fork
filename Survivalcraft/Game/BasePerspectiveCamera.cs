...
namespace Game
{
	public abstract class BasePerspectiveCamera : Camera
	{
		...
		private Vector3 m_viewUp;

		private Vector3 m_viewRight;

		private Matrix? m_viewMatrix;

		private Matrix? m_invertedViewMatrix;

		private Matrix? m_projectionMatrix;

		private Matrix? m_invertedProjectionMatrix;

		private Matrix? m_screenProjectionMatrix;

		private Matrix? m_viewProjectionMatrix;

		private Vector2? m_viewportSize;

		private Matrix? m_viewportMatrix;

		private BoundingFrustum m_viewFrustum;

		private bool m_viewFrustumValid;
		...
		protected BasePerspectiveCamera(GameWidget gameWidget)
			: base(gameWidget)
		{
		}
