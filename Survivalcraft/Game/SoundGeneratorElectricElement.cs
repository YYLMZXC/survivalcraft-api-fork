...
namespace Game
{
	public class SoundGeneratorElectricElement : RotateableElectricElement
	{
		...
		{
			"", "Bell", "Organ", "Ping", "String", "Trumpet", "Voice", "Piano", "PianoLong", "Drums",
			"", "", "", "", "", "Piano"
		};
		...
		private string[] m_drums = new string[10] { "Snare", "BassDrum", "ClosedHiHat", "PedalHiHat", "OpenHiHat", "LowTom", "HighTom", "CrashCymbal", "RideCymbal", "HandClap" };
		...
		public override bool Simulate()
		{
			...
			if (m_lastToneInput == 0 && num4 != 0 && num != 15 && base.SubsystemElectricity.SubsystemTime.GameTime >= m_playAllowedTime)
			{
				...
				else if (!string.IsNullOrEmpty(text))
				{
					...
					text2 = string.Format("Audio/SoundGenerator/{0}C{1}", new object[2] { text, num7 });
				}
