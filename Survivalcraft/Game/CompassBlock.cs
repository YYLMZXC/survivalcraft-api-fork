	...
	public class CompassBlock : Block
	{
		...
		public override void DrawBlock(PrimitivesRenderer3D primitivesRenderer, int value, Color color, float size, ref Matrix matrix, DrawBlockEnvironmentData environmentData)
		{
			...
			if (environmentData != null && environmentData.SubsystemTerrain != null)
			{
				...
				Vector3 vector = environmentData.SubsystemTerrain.Project.FindSubsystem<SubsystemMagnetBlockBehavior>(throwOnError: true).FindNearestCompassTarget(translation);
				Vector3 vector2 = translation - vector;
				radians = Vector2.Angle(v2: new Vector2(forward.X, forward.Z), v1: new Vector2(vector2.X, vector2.Z));
			}
