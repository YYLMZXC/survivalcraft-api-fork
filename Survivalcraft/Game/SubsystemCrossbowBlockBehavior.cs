			...
			if (inventory != null)
			{
				...
				if (activeSlotIndex >= 0)
				{
					...
					if (num == 200 && slotCount > 0)
					{
						...
						Vector3 vector = (((componentMiner.ComponentCreature.ComponentBody.CrouchFactor > 0f) ? 0.01f : 0.03f) + 0.15f * MathUtils.Saturate((num2 - 2.5f) / 6f)) * new Vector3
						{
						...
						case AimState.InProgress:
						{
							...
							if (componentFirstPersonModel != null)
							{
								...
								componentFirstPersonModel.ItemOffsetOrder = new Vector3(-0.44f, 0.3f, 0.2f);
						...
						case AimState.Completed:
						{
							...
							else
							{
								...
								float num4 = 38f;
								if (m_subsystemProjectiles.FireProjectile(value2, vector2, num4 * vector3, Vector3.Zero, componentMiner.ComponentCreature) != null)
								{
