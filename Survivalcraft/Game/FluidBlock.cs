...
namespace Game
{
	public abstract class FluidBlock : CubeBlock
	{
		...
		public override void Initialize()
		{
			...
			{
				if ((object)typeInfo2.BaseType == typeof(FluidBlock))
				{
					typeInfo = typeInfo2;
					break;
				}
			...
			for (int i = 0; i < BlocksManager.Blocks.Length; i++)
			{
				...
				m_theSameFluidsByIndex[i] = (object)block.GetType().GetTypeInfo() == typeInfo || block.GetType().GetTypeInfo().IsSubclassOf(typeInfo.AsType());
			}
		}
