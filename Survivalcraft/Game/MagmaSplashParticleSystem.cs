	...
	public class MagmaSplashParticleSystem : ParticleSystem<MagmaSplashParticleSystem.Particle>
	{
			...
			: base(40)
		{
			...
			for (int i = 0; i < base.Particles.Length; i++)
			{
				...
				Vector3 vector = 4f * m_random.Float(0.1f, 1f) * Vector3.Normalize(new Vector3(m_random.Float(-1f, 1f), 0f, m_random.Float(-1f, 1f)));
				obj.Velocity = num5 * (vector + new Vector3(0f, m_random.Float(0f, 4f), 0f));
			}
		}
