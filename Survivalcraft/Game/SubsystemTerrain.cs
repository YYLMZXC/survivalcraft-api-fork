...
namespace Game
{
	public class SubsystemTerrain : Subsystem, IDrawable, IUpdateable
	{
		...
		private static int[] m_drawOrders = new int[2] { 0, 100 };

		public SubsystemGameInfo SubsystemGameInfo { get; private set; }

		public SubsystemAnimatedTextures SubsystemAnimatedTextures { get; private set; }

		public SubsystemFurnitureBlockBehavior SubsystemFurnitureBlockBehavior { get; private set; }

		public SubsystemPalette SubsystemPalette { get; private set; }

		public Terrain Terrain { get; private set; }

		public TerrainUpdater TerrainUpdater { get; private set; }

		public TerrainRenderer TerrainRenderer { get; private set; }

		public TerrainSerializer23 TerrainSerializer { get; private set; }

		public ITerrainContentsGenerator TerrainContentsGenerator { get; private set; }

		public BlockGeometryGenerator BlockGeometryGenerator { get; private set; }
