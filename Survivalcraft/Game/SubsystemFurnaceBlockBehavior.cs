...
namespace Game
{
	public class SubsystemFurnaceBlockBehavior : SubsystemBlockBehavior
	{
		...
		public override int[] HandledBlocks => new int[2] { 64, 65 };
		...
		{
			Vector3 vector = new Vector3(0.5f, 0.2f, 0.5f);
			float size = 0.15f;
			FireParticleSystem fireParticleSystem = new FireParticleSystem(new Vector3(x, y, z) + vector, size, 16f);
