...
namespace Game
{
	public class FireworksBlock : Block
	{
		...
		private static readonly string[] ShapeDisplayNames = new string[8] { "Small Burst", "Large Burst", "Circle", "Disc", "Sphere", "Short Trails", "Long Trails", "Flat Trails" };

		private static readonly string[] HeadNames = new string[8] { "HeadConeSmall", "HeadConeLarge", "HeadCylinderSmall", "HeadCylinderLarge", "HeadSphere", "HeadDiamondSmall", "HeadDiamondLarge", "HeadCylinderFlat" };
		...
		public static readonly string[] FireworksColorDisplayNames = new string[8] { "White", "Cyan", "Red", "Blue", "Yellow", "Green", "Orange", "Purple" };
		...
		public override void Initialize()
		{
			...
			for (int j = 0; j < 2; j++)
			{
				...
				Matrix matrix = Matrix.CreateScale(new Vector3(num3, 1f, num3));
				m_bodyBlockMeshes[j] = new BlockMesh();
				m_bodyBlockMeshes[j].AppendModelMeshPart(model.FindMesh("Body").MeshParts[0], boneAbsoluteTransform * matrix * Matrix.CreateTranslation(0f, -0.25f, 0f), makeEmissive: false, flipWindingOrder: false, doubleSided: false, flipNormals: false, Color.White);
			}
			for (int k = 0; k < 2; k++)
			{
