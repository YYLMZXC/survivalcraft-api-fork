...
namespace Game
{
	public class SubsystemTorchBlockBehavior : SubsystemBlockBehavior
	{
		...
		public override int[] HandledBlocks => new int[3] { 31, 17, 132 };
		...
		private void AddTorch(int value, int x, int y, int z)
		{
			...
			case 31:
				...
				{
				case 0:
					vector = new Vector3(0.5f, 0.58f, 0.27f);
					break;
				case 1:
					vector = new Vector3(0.27f, 0.58f, 0.5f);
					break;
				case 2:
					vector = new Vector3(0.5f, 0.58f, 0.73f);
					break;
				case 3:
					vector = new Vector3(0.73f, 0.58f, 0.5f);
					break;
				default:
					vector = new Vector3(0.5f, 0.53f, 0.5f);
					break;
				}
				size = 0.15f;
				break;
			case 132:
				vector = new Vector3(0.5f, 0.1f, 0.5f);
				size = 0.1f;
				break;
			default:
				vector = new Vector3(0.5f, 0.2f, 0.5f);
				size = 0.2f;
				break;
			}
			FireParticleSystem fireParticleSystem = new FireParticleSystem(new Vector3(x, y, z) + vector, size, 24f);
