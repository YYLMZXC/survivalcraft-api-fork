...
namespace Game
{
	public class ComponentBody : ComponentFrame, IUpdateable
	{
		...
		private float m_crouchFactor;

		private float m_targetCrouchFactor;
		...
		public Vector2 AirDrag { get; private set; }

		public Vector2 WaterDrag { get; private set; }

		public float WaterSwayAngle { get; private set; }

		public float WaterTurnSpeed { get; private set; }

		public float ImmersionDepth { get; private set; }

		public float ImmersionFactor { get; private set; }

		public FluidBlock ImmersionFluidBlock { get; private set; }

		public int? StandingOnValue { get; private set; }

		public ComponentBody StandingOnBody { get; private set; }

		public Vector3 StandingOnVelocity { get; private set; }
		...
		public float MaxSmoothRiseHeight { get; private set; }

		public Vector3 CollisionVelocityChange { get; private set; }
		...
		private bool MoveToFreeSpace(float maxMoveDistance)
		{
			Vector3 stanceBoxSize = StanceBoxSize;
			Vector3 position = base.Position;
		...
		private void FindCrouchCollisionBoxes(Vector3 position, Vector2 overhang, DynamicArray<CollisionBox> result)
		{
