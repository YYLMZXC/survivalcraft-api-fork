	...
	public class FourLedElectricElement : MountedElectricElement
	{
		...
		public override void OnAdded()
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				m_glowPoints[i].Position = vector - 0.4375f * CellFace.FaceToVector3(mountingFace) + 0.25f * vector4 * num + 0.25f * vector3 * num2;
				m_glowPoints[i].Forward = vector2;
				m_glowPoints[i].Up = vector3;
				m_glowPoints[i].Right = vector4;
