...
namespace Game
{
	public static class CraftingRecipesManager
	{
		...
		{
			foreach (XElement item in ContentManager.Get<XElement>("CraftingRecipes").Descendants("Recipe"))
			{
			...
			if (craftingRecipe != null)
			{
				...
				else if (playerLevel < craftingRecipe.RequiredPlayerLevel)
				{
					if (craftingRecipe.RequiredHeatLevel > 0f)
					{
						...
						craftingRecipe2.Message = $"You must be level {craftingRecipe.RequiredPlayerLevel} to smelt this item";
						craftingRecipe = craftingRecipe2;
					}
					else
					{
						CraftingRecipe craftingRecipe2 = new CraftingRecipe();
						craftingRecipe2.Message = $"You must be level {craftingRecipe.RequiredPlayerLevel} to craft this item";
						craftingRecipe = craftingRecipe2;
					}
				}
			}
