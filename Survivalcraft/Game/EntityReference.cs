	...
	public struct EntityReference
	{
		...
		public string ReferenceString
		{
			get
			{
				...
				{
					return string.Format("id:{0}:{1}", new object[2] { m_entityReference, m_componentReference });
				}
				if (m_referenceType == ReferenceType.ByEntityName)
				{
					return string.Format("name:{0}:{1}", new object[2] { m_entityReference, m_componentReference });
				}
