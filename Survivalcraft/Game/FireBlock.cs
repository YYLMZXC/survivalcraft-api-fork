	...
	public class FireBlock : Block
	{
		...
		public override void GenerateTerrainVertices(BlockGeometryGenerator generator, TerrainGeometry geometry, int value, int x, int y, int z)
		{
			...
			if (HasFireOnFace(data, 0))
			{
				...
				TerrainGeometryDynamicArray<ushort> indices = alphaTestSubsetsByFace[0].Indices;
			...
			if (HasFireOnFace(data, 1))
			{
				...
				TerrainGeometryDynamicArray<ushort> indices2 = alphaTestSubsetsByFace[1].Indices;
			...
			if (HasFireOnFace(data, 2))
			{
				...
				TerrainGeometryDynamicArray<ushort> indices3 = alphaTestSubsetsByFace[2].Indices;
			...
			TerrainGeometryDynamicArray<ushort> indices4 = alphaTestSubsetsByFace[3].Indices;
