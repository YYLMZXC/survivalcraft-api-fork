		...
		public override void Load(ValuesDictionary valuesDictionary, IdToEntityMap idToEntityMap)
		{
			...
			m_stateMachine.AddState("Stare", delegate
			{
				...
				if (m_target != null)
				{
					...
					Vector3 vector = Vector3.Normalize(m_target.ComponentBody.Position - position);
					m_componentPathfinding.SetDestination(position + 1.1f * vector, m_random.Float(0.3f, 0.4f), 1f, 0, useRandomMovements: false, ignoreHeightDifference: true, raycastDestination: false, null);
