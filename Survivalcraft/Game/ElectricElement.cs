...
namespace Game
{
	...
	{
		public SubsystemElectricity SubsystemElectricity { get; private set; }

		public ReadOnlyList<CellFace> CellFaces { get; private set; }

		public List<ElectricConnection> Connections { get; private set; }
		...
		protected ElectricElement(SubsystemElectricity subsystemElectricity, CellFace cellFace)
			: this(subsystemElectricity, new List<CellFace> { cellFace })
		{
		}
