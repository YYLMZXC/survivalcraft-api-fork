...
namespace Game
{
	public class SnowballBlock : Block
	{
		...
		public override void Initialize()
		{
			...
			m_standaloneBlockMesh.AppendModelMeshPart(model.FindMesh("Snowball").MeshParts[0], boneAbsoluteTransform * Matrix.CreateTranslation(0f, 0f, 0f), makeEmissive: false, flipWindingOrder: false, doubleSided: false, flipNormals: false, Color.White);
			base.Initialize();
		}
