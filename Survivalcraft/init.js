...
var OnMinerDigHandlers = new Array();//当人物挖掘方块时执行，任一返回true后不执行原挖掘操作
...
var OnMinerPlaceHandlers = new Array();//当人物放置方块时执行，任一返回true后不执行原放置操作
...
var OnPlayerSpawnedHandlers = new Array();//人物出生时执行
...
var OnPlayerDeadHandlers = new Array();//人物出生时执行
...
/*OnCreatureInjureHandlers.push((componentHealth, amount, attacker, ignoreInvulnerability, cause) => {//ComponentHealth componentHealth, float amount, ComponentCreature attacker, bool ignoreInvulnerability, string cause
    attacker.componentHealth.Health = 0;
    return false;
});*/
