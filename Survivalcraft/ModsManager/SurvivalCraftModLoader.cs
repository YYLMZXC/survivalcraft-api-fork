...
namespace Game
{
    public class SurvivalCraftModLoader(IModLoader parent) : SurvivalCraftModInterface(parent), IModLoader
    {
        public ModEntity ModEntity { get; set; }

        public void _OnLoaderInitialize()
        {
            ModInterfacesManager.RegisterInterface<SurvivalCraftModLoader>();
