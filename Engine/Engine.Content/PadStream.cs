...
namespace Engine.Content
{
	public class PadStream : Stream
	{
		...
		private static void AddPad(byte[] buffer, int offset, int count, long position, byte[] pad)
		{
		...
		private static byte AddPad(byte b, long position, byte[] pad)
		{
