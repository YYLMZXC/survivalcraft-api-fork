...
namespace FluxJpeg.Core.Encoder
{
	internal class JpegEncoder
	{
		...
		private static readonly int[] CompID = new int[3]
		{
			1,
			2,
			3
		...
		private static readonly int[] QtableNumber = new int[3]
		{
			0,
			1,
			1
		...
		private static readonly int[] DCtableNumber = new int[3]
		{
			0,
			1,
			1
		...
		private static readonly int[] ACtableNumber = new int[3]
		{
			0,
			1,
			1
